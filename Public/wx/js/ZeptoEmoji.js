...
(function (AllPass) {
    var Emoji = (function () {
        function Emoji() {
            ...
            this.scroller = null;
            var www = $('.hiddenInput').width()
            this.default_width = www;
            /*计算移动变量*/
            this.startX = 0;
            this.x = 0;
            this.curX = 0;
        ...
        Emoji.prototype.Init = function () {
            ...
            this.index = 0;
            var img;
            if (window.devicePixelRatio >= 1.5 || Zepto.browser.ie)
                img = "/Public/wx/img/emoji/1@2x.png?max_age=19830211";
            else
                img = "/Public/wx/img/emoji/1.png?max_age=19830211";
            var imgPath = img;
