...
<section class="container">
	...
	<div class="familyTree">
		<ul class="row">
			<form action="/Agents/family" method="post">
				<li class="col-lg-3 col-xs-12 col-sm-3 col-md-3">
				<label>会员编号：</label>
				<input class="iptText rds5" type="text" name="mid" value="<?php echo ($mid); ?>">
				</li>
				<li class="col-lg-3 col-xs-12 col-sm-3 col-md-3">
					<label>会员姓名：</label>
				...
				<li class="col-lg-2 col-xs-12 col-sm-2 col-md-2">
					<label></label>
						...
						<select  data-criteria="equal" name="level"  class="rds5">
							...
							<option value="1"  <?php if($level == 1): ?>selected="selected"<?php endif; ?> >第一代</option>
							<option value="2"  <?php if($level == 2): ?>selected="selected"<?php endif; ?>>第二代</option>
							<option value="3"  <?php if($level == 3): ?>selected="selected"<?php endif; ?>>第三代</option>
						</select>
						</span>
				</li>
		...
		<table class="row listTable table-hover table">
			<thead>
				<tr>
					<th class="sorting_desc hidden-xs" tabindex="0" aria-controls="datatable-generation-tree-report" rowspan="1" colspan="1" aria-label="会员编号" aria-sort="descending">
						会员编号
					</th>
					<th class="sorting_desc" tabindex="0" aria-controls="datatable-generation-tree-report" rowspan="1" colspan="1" aria-label="会员姓名" aria-sort="descending">
						会员姓名
					</th>
					<th class="sorting_desc" tabindex="0" aria-controls="datatable-generation-tree-report" rowspan="1" colspan="1" aria-label="直荐会员" aria-sort="descending">
						直荐会员
					</th>
				</tr>
			</thead>
			<?php if(is_array($selectArray)): $i = 0; $__LIST__ = $selectArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$al): $mod = ($i % 2 );++$i;?><tr>
					<td class="hidden-xs"><a href="/index.php/Agents/familyInfo/msn/<?php echo ($al["msn"]); ?>"><?php echo ($al["msn"]); ?></a></td>
					<td><?php echo ($al["nickname"]); ?></td>
					<td><?php echo (getLevel($al["level"])); ?></td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			<?php if(is_array($oone)): $i = 0; $__LIST__ = $oone;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$al): $mod = ($i % 2 );++$i;?><tr>
					<td class="hidden-xs"><a href="/index.php/Agents/familyInfo/msn/<?php echo ($al["msn"]); ?>"><?php echo ($al["msn"]); ?></a></td>
					<td><?php echo ($al["nickname"]); ?></td>
					<td>第一代</td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			<?php if(is_array($ttwo)): $i = 0; $__LIST__ = $ttwo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$al): $mod = ($i % 2 );++$i;?><tr>
					<td class="hidden-xs"><a href="/index.php/Agents/familyInfo/msn/<?php echo ($al["msn"]); ?>"><?php echo ($al["msn"]); ?></a></td>
					<td><?php echo ($al["nickname"]); ?></td>
					<td>第二代</td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
			<?php if(is_array($tthree)): $i = 0; $__LIST__ = $tthree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$al): $mod = ($i % 2 );++$i;?><tr>
					<td class="hidden-xs"><a href="/index.php/Agents/familyInfo/msn/<?php echo ($al["msn"]); ?>"><?php echo ($al["msn"]); ?></a></td>
					<td><?php echo ($al["nickname"]); ?></td>
					<td>第三代</td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
