...
<body>
<link rel="stylesheet" href="/Public/Plugin/Validform/Validform.css" />
...
<style>
	...
	.iptText { padding: .5em; }
	.SexBtn input { margin:0 .2em 0 0;}
	.form-group .iptBtn {padding: .5em 1em;}
	#liveCity select { padding: .5em; border: 1px solid #1ea78d; }
</style>
<style>
...
<section class="container">
	...
	<!--真实姓名-->
	<form action="/Member/viewEdit" method="post" class="AddUserForm">
		<div class="container">
			<div class="row form-group">
				...
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="iptText rds5 col-xs-12 col-sm-8 col-md-8 col-lg-8" name="realname" value="<?php echo ($memInfo["realname"]); ?>"  autocomplete="off" datatype="*" errormsg="内容不能为空">
				</div>
			</div>
			<!--昵称-->
			<div class="row form-group">
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<span class="form-control-static field-label">昵称</span>
				</div>
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="iptText rds5 col-xs-12 col-sm-8 col-md-8 col-lg-8" name="nickname" value="<?php echo ($memInfo["nickname"]); ?>"  autocomplete="off" datatype="*" errormsg="内容不能为空">
				</div>
			</div>
			...
			<div class="row form-group">
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<span class="form-control-static field-label">地区选择：</span>
				</div>
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<span class="form-control-static field-label">
						<div id="liveCity">
							<select class="prov rds5" name="prov"></select>
							<select class="city rds5" name="city" disabled="disabled"></select>
							<select class="dist rds5" name="dist" disabled="disabled"></select>
						</div>
					</span>
				</div>
			</div>
			...
			<div class="row form-group">
				...
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="iptText rds5 col-xs-12 col-sm-8 col-md-8 col-lg-8" name="address" value="<?php echo ($memInfo["address"]); ?>" datatype="*" errormsg="内容不能为空">
				</div>
			</div>
			<!--生日-->
			<div class="row form-group">
          ...
          <span class="form-control-static field-label">
              生日：
				...
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<!-- <input type="text" class="iptText rds5 col-xs-12 col-sm-8 col-md-8 col-lg-8" name="birthday" value="<?php echo ($memInfo["birthday"]); ?>"> -->
					<input class="timeSelect iptText rds5" style="line-height:1em;" name="birthday" type="date" value="<?php echo ($memInfo["birthday"]); ?>" datatype="*" errormsg="内容不能为空">
				</div>
			</div>
			<!--性别-->
			<div class="row form-group SexBtn">
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					<span class="form-control-static field-label">性别：</span>
				</div>
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<input type="radio" datatype="*" name="sex" value="1" <?php if($memInfo["sex"] == 1): ?>checked="checked"<?php endif; ?> >男
					<input type="radio" name="sex" value="2" <?php if($memInfo["sex"] == 2): ?>checked="checked"<?php endif; ?>>女
				</div>
			</div>
			<!--电邮地址-->
			<div class="row form-group">
				...
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="iptText rds5 col-xs-12 col-sm-8 col-md-8 col-lg-8" name="email" value="<?php echo ($memInfo["email"]); ?>" placeholder="邮箱地址" autocomplete="off" datatype="e" errormsg="邮箱格式错误"/>
				</div>
			</div>
			<!--电话号码-->
			<!--div class="row form-group">
				...
				<input type="text" class="iptText rds5 col-xs-12 col-sm-8 col-md-8 col-lg-8" name="email" value="<?php echo ($memInfo["mobile_phone"]); ?>" placeholder="手机号" autocomplete="off" datatype="m" errormsg="手机号格式错误" />
				</div>
			</div-->
			
			<div class="row form-group">
				<div class="text-right">
					<button type="submit" class="iptBtn rds5 userAdd">确定</button>
				</div>
			</div>
		</div>
	</form>
...
<script>
		//居住地联动
		$("#liveCity").citySelect({
			prov:"<?php echo ($memInfo["prov"]); ?>",
			city:"<?php echo ($memInfo["city"]); ?>",
			dist:"<?php echo ($memInfo["dist"]); ?>",
			nodata:"none"
		});
		//表单验证
		$(function(){
