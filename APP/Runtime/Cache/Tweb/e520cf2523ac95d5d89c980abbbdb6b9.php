		...
		<div class= "container">
			<div class="row form-group">
				<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
					<span class="form-control-static field-label">用户编号：</span>
				</div>
				<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
					<span class="form-control-static"><?php echo ($memInfo["msn"]); ?></span>
				</div>
			</div>
			<div class="row form-group">
				<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
			...
			<div class="row form-group">
				<a href="/Member/viewEdit"><div class="text-right">
					<button type="submit" class="iptBtn rds5" name="ButtonAction" value="BillingInformationEdit">编辑</button>
				</div></a>
			</div>
    </div>
	</section>
