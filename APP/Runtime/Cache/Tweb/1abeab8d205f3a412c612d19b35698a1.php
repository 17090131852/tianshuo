...
<body>
	<style>
		.ucenter{ padding:1em; }
		.ucenter li{ margin:1em 0;  }
		.ucenter li h3{ margin:0; font-size:1.4em; color:#333; line-height:2.2em; text-indent:1em; border-bottom:1px solid #ddd;  }
		.ucenter li div img{ width:120px; float:left; margin:1.5em; }
		.txtInfo{ float:right; margin:1em 1em 0 0; line-height:1.5em; font-size:1.1em; color: #999; }
		.txtInfo span { color: #333; }
		.ucenter li div div p{text-align:right; }
		.memSta{ border:1px solid #ddd; }
	</style>
...
<ul class="row nav nav-tabs col-lg-12 clearfix">
	...
	<section class="container">
		<ul class="ucenter clearfix">
			<li class="col-lg-6">
				<a href="<?php echo U('Member/view');?>">
					<div class="memSta clearfix">
						<h3>会员状态</h3>
						<div>
							<img class="menuPic" src="<?php echo ($memData["imgPath"]); ?>" width="120" height="120" />
							<div class="txtInfo">
								<p>
								会员级别：<span><?php echo ($memData["type"]); ?></span>
								</p>
								<p>注册时间：<span><?php echo ($memData["reg_time"]); ?></span>	</p>
							</div>
						</div>
					</div>
				</a>
			...
			<li class="col-lg-6">
				<a href="<?php echo U('Agents/family');?>">
					<div class="memSta clearfix">
						<h3>家谱树</h3>
						<div>
							<img src="/Public/Images/Tweb/homeTreeIcon.jpg" width="120" height="120" />
							<div class="txtInfo">
								<p>第一代总人数：<span><?php echo ($memData["one"]); ?></span></p>
								<p>第二代总人数：<span><?php echo ($memData["two"]); ?></span></p>
								<p>第三代总人数：<span><?php echo ($memData["three"]); ?></span></p>
							</div>
						</div>
					</div>
				</a>
			...
			<li class="col-lg-6">
				<a href="<?php echo U('Member/pointList');?>">
					<div class="memSta clearfix">
					<h3>积分</h3>
					<div>
						<img src="/Public/Images/Tweb/integralIcon.jpg" width="120" height="120" />
							<div class="txtInfo">
								<p>剩余积分：<span><?php echo ($memData["leave_score"]); ?>&nbsp;BV</span></p>
								<p>剩余定向积分：<span><?php echo ($memData["leave_orient_score"]); ?>&nbsp;BV</span></p>
							</div>
						</div>
					</div>
				</a>
			...
			<li class="col-lg-6">
				<a href="<?php echo U('Award/index');?>">
					<div class="memSta clearfix">
					<h3>电子钱包</h3>
					<div>
						<img src="/Public/Images/Tweb/moneyIcon.jpg" width="120" height="120" />
						<div class="txtInfo">
							<p>全部未提现金额：<span><?php echo ($memData["leave_money"]); ?></span></p>
						</div>
					</div>
				</div>
				</a>
