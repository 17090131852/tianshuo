...
<section class="container">
	<form action="<?php echo U('Member/add');?>" method="post" id="regForm" class="AddUserForm">
		<fieldset class="row col-lg-12">
		    ...
		    <label for="nickname" class="item-label col-sm-2 control-label">昵称:</label>
		    <div class="col-sm-8">
		      <input type="text" id="nickname" name="nickname" class="form-control" value="" placeholder="昵称" autocomplete="off" datatype="s2-16" errormsg="昵称2-16字符" />
		    </div>
		  </div>
		  <!--手机号-->
		  <div class="form-group clearfix">
		    <label for="mobile_phone" class="item-label col-sm-2 control-label">手机号:</label>
		    <div class="col-sm-8">
		      <input type="text" id="mobile_phone" name="mobile_phone"   value="" class="form-control" placeholder="手机号" autocomplete="off" datatype="m" errormsg="手机号格式错误" />
		    </div>
		  </div>
		  <!--提交按钮-->
