...
<body>
	...
	<style>
		...
		.allCar{ margin:2em auto 0 auto;}
		.allCar .FirmPic{text-align: center;}
		.allCar .FirmPic img{ padding:0; margin: 0 auto; border:1px solid #ddd; width: 100%;}
		.allCar .FirmPic span{ display:block; margin-top:1em; text-align: center; color: #666;}
		.allCar .FirmPic a{ display: block; margin: 0 auto; margin-top: 14px; margin-bottom: 30px; width: 80px; height: 26px; text-align: center; color: #64b877; border: 1px solid #64b877; font-size: .75em; line-height: 26px;}
		section .allCar .FirmPic a:hover{color: #fff; background: #64b877; text-decoration: none;}
		
		.carClass img{ margin-top:1em; }
	...
	<div class="breadNav clearfix hidden-xs">
		<ol class="breadcrumb">
			<li>当前位置：</li>
			<li><a href="/index.php">主页</a></li>
			<li class="active">车型总览</li>
		</ol>
	</div>
	<section class="container clearfix">
		<div class="allCar">
			<div class="row carClass">
				<a href="<?php echo U('MotoType/carType/cate/11');?>"><img class="col-md-3 col-sm-3 col-xs-6" src="<?php echo C('UPLOAD_SAVAPATH');?>Test/MotoType1.jpg" alt="环卫" /></a>
				<a href="<?php echo U('MotoType/carType/cate/10');?>"><img class="col-md-3 col-sm-3 col-xs-6" src="<?php echo C('UPLOAD_SAVAPATH');?>Test/MotoType2.jpg" alt="小型" /></a>
				<a href="<?php echo U('MotoType/carType/cate/13');?>"><img class="col-md-3 col-sm-3 col-xs-6" src="<?php echo C('UPLOAD_SAVAPATH');?>Test/MotoType3.jpg" alt="专用" style="float:right" /></a>
				<a href="<?php echo U('MotoType/carType/cate/12');?>"><img class="col-md-3 col-sm-3 col-xs-6" src="<?php echo C('UPLOAD_SAVAPATH');?>Test/MotoType4.jpg" alt="物流" /></a>
			</div>
		</div>
		<div class="allCar">
			<div class="row FirmPic">
		    <?php if($carList[0]['title'] != ''): if(is_array($carList)): $i = 0; $__LIST__ = $carList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$carVo): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-sm-3 col-xs-6">
							<img src="<?php echo C('DOMAIN_NAME');?>/<?php echo ($carVo["cover"]); ?>" alt="">
							<span><?php echo ($carVo["title"]); ?></span>
							<a href="/index.php/MotoType/carDetail/id/<?php echo ($carVo["id"]); ?>">了解产品</a> 
						</div><?php endforeach; endif; else: echo "" ;endif; ?>
				<?php else: ?>
					<p class="NoNews">此车型暂时没有车辆！</p><?php endif; ?>
			</div>
			<!--分页-->
			<nav>
			  <ul class="pagination">
