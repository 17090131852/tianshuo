...
<style>
	...
	.iptBtn{ height:1.8em; line-height:1.8em; padding:.5em 1em; }
...
<div class="TableBox">
	<h1 class="pageTitle"> 收货地址 </h1>
	<div class="table-responsive">
		<table class="table table-hover">
		<?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="row">
		  	<td><?php echo ($vo["realname"]); ?></td>
		  	<td><?php echo ($vo["tel"]); ?></td>
		  	<td><?php echo ($vo["province"]); ?> <?php echo ($vo["city"]); ?> <?php echo ($vo["county"]); ?>  <?php echo ($vo["address"]); ?></td>
		  	<td>
		  		<a class="btn btn-info" href="/Member/addPostAddr/id/<?php echo ($vo["id"]); ?>">编辑</a>
		  		<a class="btn btn-danger" href="/Member/delPostAddr/id/<?php echo ($vo["id"]); ?>" onclick="if(confirm('确定删除吗?')==false){ return false; }">删除</a>
		  	</td>
		  </tr><?php endforeach; endif; else: echo "" ;endif; ?>
		</table>
		</div>
		<a class="iptBtn rds5" href="/Member/addPostAddr">增加</a>
	</div>
</section>
	<style>
